...
class GAT_GCN_with_p(torch.nn.Module):
    def __init__(self, n_output=1, num_features_xd=78, num_features_xt=25,
        ...
        self.gnn2_1 = GCNConv(num_features_xd * 2 ** self.output_dim_power_0 * self.heads_1, num_features_xd * 2 ** self.output_dim_power_1)
