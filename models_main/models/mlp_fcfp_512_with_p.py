...
# GCN based model
class MLPNet_FCFP512_with_p(torch.nn.Module):
    def __init__(self, n_output=1, n_filters=32, embed_dim=128,num_features_xd=78, num_features_xt=25, output_dim=128, dropout=0.2, protein_processing_type="convolution", featurizer=False):
        ...
        super(MLPNet_FCFP512_with_p, self).__init__()
        ...
        self.dropout_connection_layers = 0.726
        self.act = "relu"
        ...
        self.fc_g1 = nn.Linear(num_features_xd * 2 ** self.output_dim_power_6, self.output_dim)
