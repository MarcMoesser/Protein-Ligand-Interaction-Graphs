...
class SageNet_no_p(torch.nn.Module):
    def __init__(self, n_output=1, n_filters=32, embed_dim=128,num_features_xd=78, num_features_xt=25, output_dim=128, dropout=0.2, protein_processing_type="convolution",  featurizer=False):
        ...
        super(SageNet_no_p, self).__init__()
        ...
        self.dropout_GNN_layers = 0.019
        self.output_dim_power_0 = 2
        self.output_dim_power_1 = 0
        self.dropout_connection_layers = 0.147
        self.act = "leaky_relu"
        ...
        self.fc_g1 = nn.Linear(num_features_xd * 2 ** self.output_dim_power_1, self.output_dim)
