...
# GCN based model
class MLPNet_ECFP1024_with_p(torch.nn.Module):
    def __init__(self, n_output=1, n_filters=32, embed_dim=128,num_features_xd=78, num_features_xt=25, output_dim=128, dropout=0.2, protein_processing_type="convolution", featurizer=False):
        ...
        super(MLPNet_ECFP1024_with_p, self).__init__()
        ...
        self.dropout_MLP_layers = 0.046
        self.output_dim_power_0 = 1
        self.output_dim_power_1 = 0
        self.output_dim_power_2 = 1
        self.output_dim_power_3 = 2
        self.output_dim_power_4 = 1
        self.output_dim_power_5 = 1
        self.output_dim_power_6 = 1
        self.output_dim_power_7 = 2

        self.dropout_connection_layers = 0.042
        self.act = "leaky_relu"
        ...
        self.mlp_7 = nn.Linear(num_features_xd * 2 ** self.output_dim_power_5, num_features_xd * 2 ** self.output_dim_power_6)
        self.mlp_8 = nn.Linear(num_features_xd * 2 ** self.output_dim_power_6, num_features_xd * 2 ** self.output_dim_power_7)
