'''This is the best model: gat_PLIG_no_p.py, now modified expect muliple
arguments in the forward function.'''
import torch
...
class GATNet_PLIG_no_p(torch.nn.Module):
    def __init__(self, num_features_xd=78, n_output=1, num_features_xt=25,
        ...
        self.act = "relu"
        self.activation = F.relu #activation_function_dict[self.act]
    ...
    def forward(self, x, edge_index, batch):
        ...
        #     xc = torch.cat((x, xt), 1)
        # else:    
        xc = x # this was in the else bracket
